...
section .data
   ...
   c dq 0.0
   d dq 0.0
   cadena_0 db 'Fin del programa', 0
...
etiqueta_inicio_140573589129872:
   mov eax, [b] ; Cargar variable b en eax
   ...
   jne etiqueta_fin_while_140573589129872 ; Saltar al final si la condición es falsa
   mov eax, [b] ; Cargar variable b en eax
   push eax; guardar en la pila
   ...
   call printf
   add esp, 12
   jmp etiqueta_inicio_140573589129872 ; Saltar al inicio del ciclo
etiqueta_fin_while_140573589129872:
